 ...
 */
public abstract class Hilt_FragmentProfil extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentProfil(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentProfil_GeneratedInjector) this.generatedComponent()).injectFragmentProfil(UnsafeCasts.<FragmentProfil>unsafeCast(this));
    }
  }
