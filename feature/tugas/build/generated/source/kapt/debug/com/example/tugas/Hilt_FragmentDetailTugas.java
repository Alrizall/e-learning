 ...
 */
public abstract class Hilt_FragmentDetailTugas extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentDetailTugas() {
    super();
  }

  Hilt_FragmentDetailTugas(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentDetailTugas_GeneratedInjector) this.generatedComponent()).injectFragmentDetailTugas(UnsafeCasts.<FragmentDetailTugas>unsafeCast(this));
    }
  }
