 ...
 */
public abstract class Hilt_FragmentDetailMateri extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentDetailMateri() {
    super();
  }

  Hilt_FragmentDetailMateri(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentDetailMateri_GeneratedInjector) this.generatedComponent()).injectFragmentDetailMateri(UnsafeCasts.<FragmentDetailMateri>unsafeCast(this));
    }
  }
