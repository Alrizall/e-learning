 ...
 */
public abstract class Hilt_FragmentQuiz extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentQuiz(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentQuiz_GeneratedInjector) this.generatedComponent()).injectFragmentQuiz(UnsafeCasts.<FragmentQuiz>unsafeCast(this));
    }
  }
