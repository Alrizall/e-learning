 ...
 */
public abstract class Hilt_FragmentNilai extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentNilai(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentNilai_GeneratedInjector) this.generatedComponent()).injectFragmentNilai(UnsafeCasts.<FragmentNilai>unsafeCast(this));
    }
  }
